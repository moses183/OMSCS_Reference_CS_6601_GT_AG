...
# Author:͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
# Last Updated: 12/18/2023 by Raymond Jia͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
...
# Class for Priority Queue testing͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
...
# Class for BFS testing͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
class TestBFS(unittest.TestCase):
    """Test BFS Implementation"""
    def __init__(self, methodName: str = ...) -> None:
        super().__init__(methodName)

        # Setup graph͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        ...
        # Setup references͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
    ...
    def is_valid_path(self, graph, src_node, dst_node, path):
        ...
        # Check if stationary path͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        if src_node == dst_node:
            return not path
        
        # Check endpoints͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        if not ((path[0] == src_node and path[-1] == dst_node) or (path[-1] == src_node and path[0] == dst_node)):
            return False
        
        # Check path continuity͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
    ...
    def is_optimal_path(self, case, path):
        ...
        # Check if ref_path is accidentally flipped͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
    ...
    def test_valid_paths(self, breadth_first_search):
        # Collect all student paths͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        student_solns = {}
        ...
        # Check if all paths are valid͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        failed = 0
        sample_failed_case = ""
    ...
    def test_optimal_paths(self, breadth_first_search):
        ...
        # Check if all paths are optimal͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        failed = 0
        sample_failed_case = ""
        for case in student_solns:
...
# Class for two-goal search algorithm testing͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
...
# Class for testing Euclidean Distance Heuristic͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
class TestEuclideanHeuristic(unittest.TestCase):
    ...
    def test_euclidean_distance(self, euclidean_dist_heuristic):
        ...
        # Test neighbors͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        self.assertEqual(euclidean_dist_heuristic(self.romania, 'n', 'i'), 73.824)

        # Test non-neighbors͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        self.assertEqual(euclidean_dist_heuristic(self.romania, 'n', 'u'), 193.569)
        
        print_success_message(self._testMethodName)

# Class for three-goal search algorithm testing͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
class TestTriSearchAlgorithms(unittest.TestCase):
    ...
    def is_valid_path(self, graph, goals, path):
        ...
        # Check path contains all goals͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        for goal in goals:
            if goal not in path:
                return False
