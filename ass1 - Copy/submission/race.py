...
def haversine_dist_heuristic(graph, u, v):
    ...
    #Load latitude and longitude coordinates in radians:͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
    ...
    #Now we want to execute portions of the formula:͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
...
def load_data(graph, time_left):
    ...
    * To get edge weight, use graph.get_edge_weight(node1, node2)
    ...
    # nodes = graph.nodes()͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
    return None
