# Board visualization with ipywidgets͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
import copy
...
def get_viz_board_state(game, show_legal_moves):
    ...
    active_player = 'k1' if game.__active_player__ is game.__player_1__ else 'k2'
    if show_legal_moves:
        for r,c in legal_moves: 
            if board_state[r][c][0] != 'K':
...
class ReplayGame():
    ...
    def show_board(self):
        # Show slider for move selection͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        ...
        #Left side͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        grid[:3, :-3] = self.gridb
        grid[3, :-3] = slider

        #Right side͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
