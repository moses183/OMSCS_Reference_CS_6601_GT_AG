#!/usr/bin/env python͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
import traceback
...
def correctOpenEvalFn(yourOpenEvalFn):
    ...
    try:
        ...
        # setting up the board as though we've been playing͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        board_state = [
            [' ', ' ', ' ', 'X', ' ', ' ', ' ', ' ', ' '],
            [' ', 'X', ' ', ' ', ' ', ' ', 'X', ' ', 'K2'],
            [' ', ' ', 'X', 'X', ' ', ' ', 'X', ' ', 'X'],
        ...
        #test = sample_board.get_legal_moves()͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        h = yourOpenEvalFn()
...
def beatRandom(yourAgent):
    ...
    try:
        ...
        # Uncomment to see game͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
        # print game_as_text(winner, move_history, termination, output_b)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
    except NotImplementedError:
...
def minimaxTest(yourAgent, minimax_fn):
    ...
    # create dummy 9x9 board͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄐͏󠄃͏︃
